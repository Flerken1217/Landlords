...
public:
    ...
    static QSet<Character> characters;

    explicit Player(QObject *parent = nullptr);
    explicit Player(QString name, QObject *parent = nullptr);

    //设置character集
    static void initCharaters();
    // 设置/获取当前玩家的名字
    ...
    void setCharacter(const Character& other);
...
protected:
    ...
    Character m_character;  //设置玩家角色
    //Sex m_sex;              // 玩家的性别
    Direction m_direct;     // 人物头像的显示方式: 左侧 or 右侧
    bool m_isWin;           // 记录当前玩家是否赢了游戏
    int m_timesforSend;     //玩家出牌的次数
    int m_bottomScore;      //玩家的底分
};
